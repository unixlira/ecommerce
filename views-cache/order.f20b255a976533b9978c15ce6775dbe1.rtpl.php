...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            De
            <address>
                <strong>Lira Store | DIG PLAY TECH</strong><br>
                Rua Mogi Mirim, 20 - Móoca<br>
                São Paulo - SP<br>
                Telefone: (11) 2605-1411<br>
                E-mail: lira@digplay.tech
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
            Para
            <address>
                <strong><?php echo correct_encoding($order["desperson"]); ?></strong><br>
                ...
                <?php echo correct_encoding($order["descity"]); ?> - <?php echo htmlspecialchars( $order["desstate"], ENT_COMPAT, 'UTF-8', FALSE ); ?><br>
