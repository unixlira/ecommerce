...
<!--
    E-Commerce Store by José Roberto Lira
-->
<html lang="pt-br">
  <head>
    <meta charset="utf-8">
    ...
    <title>Lira Store</title>
    <link rel="shortcut icon" href="/resources/site/img/icon.ico" />
    <!-- Google Fonts -->
  ...
  <body>
    ...
    <div class="header-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu text-decoration-none">
                        <ul>                            
                ...
                <div class="col-md-4">
                    <div class="header-right text-decoration-none">
                        <ul class="list-unstyled list-inline">
                            ...
                            <li class="dropdown dropdown-small">
                                ...
                                <a href="/profile" data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle">
